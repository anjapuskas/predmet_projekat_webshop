...
export const AddOrder = async (request) => {
    try {  
        const response = await axiosInstance.post(`${process.env.REACT_APP_BACKEND_APPLICATION_ENDPOINT}/orders`, request);
...
export const CancelOrder = async (id) => {
    try {
        const response = await axiosInstance.put(`${process.env.REACT_APP_BACKEND_APPLICATION_ENDPOINT}/orders/cancel/${id}`);
        return response.data;
    } catch (error) {
     throw new Error(error.response.data.error);
    }
...
export const ApproveOrderAction = async (id) => {
    try {
        const response = await axiosInstance.put(`${process.env.REACT_APP_BACKEND_APPLICATION_ENDPOINT}/orders/approve/${id}`);
        return response.data;
    } catch (error) {
     throw new Error(error.response.data.error);
    }
